...
from src.infra.db.sql.orm.auth_orm import Base as AuthBase
from src.infra.db.sql.orm.mail_template_orm import Base as MailTemplateBase
...
target_metadata = [AuthBase.metadata, MailTemplateBase.metadata]
